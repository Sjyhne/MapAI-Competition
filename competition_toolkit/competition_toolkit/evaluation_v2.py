...
if __name__ == "__main__":
    """
    use shell:
    python evaluation_v2.py --task 1 --data-ratio 0.1 --data-type validation --submission-path /home/gefeik/PhD-work/BLDSeg_AIComp/codes_comp/MapAI-Competition/team_GISers/src/runs/task_1/run_12 --team 1
    """
    ...
    submission_path = Path(args.submission_path) # base_path.joinpath(args.submission_path)
    # task_path = submission_path.joinpath("task_" + str(args.task))
    prediction_path = submission_path.joinpath("predictions")
    ...
    print('score:', (iscore+bscore)/2, "iou: ", iscore, "biou:", bscore)
