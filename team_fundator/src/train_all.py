...
from utils import create_run_dir, store_model_weights, record_scores, get_model, get_optimizer, get_losses, smp_models
...
def train(opts):
    ...
    for model_name in smp_models.keys():
        ...
        for e in range(epochs):
            ...
            scoredict = {
                ...
                "encoder_name": opts["model"]["encoder"]
            }
