...
def main(args):
    ...
    onnx_share_link = "https://drive.google.com/file/d/1ApK4uT16r40pNxfHHprObH12mLV3h-KL/view?usp=share_link"

    # Download trained model ready for inference
    model_checkpoint = "task1.onnx"
    ...
    model = create_model("task1.onnx", cpu=args.device=="cpu")
